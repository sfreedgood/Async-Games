  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService): TypeOrmModuleOptions => {
        ...
        const allowProdSync = dbConfig.allowSynchronizeInProduction;
        ...
        return {
          ...
          ssl: dbConfig.ssl
            ...
            : false,
          synchronize,
          // Connection retry/timeout knobs are parsed and validated centrally in
          // database.config.ts so a malformed value fails fast there rather than
          // reaching the driver as NaN.
